...
:::::::::::::::::::::::::......:::..:::::..::........::..:::::..:::::..::::::.......:::..:::::..::........:::......:::
        ...
        sleep 4.0                                                                                                                                                                                                
        system 'clear'
        puts "Mwahaha. Please, Come in!!!".red
    end

    def player_login
        puts "Greetings #{@user}, let's build a character!".green
        sleep 2.00
        Player.get_user(@user)
    end

    def create_new_player
        user_response =  @prompt.yes?("It doesn't look like you've created any characters yet. Do you want to create a new profile?".red)
            if user_response 
    ...
    def delete_avatar
        ...
        avatar_list = get_avatar_names_for_player_by_id
        if avatar_list != []
            @answer =  @prompt.select("which avatar would you like to delete?", avatar_list, symbols: { marker: "⚔️"})
